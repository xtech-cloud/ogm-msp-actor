...
var file_proto_actor_domain_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x32, 0xfd, 0x01,
	0x0a, 0x06, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x3c, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x12, 0x1a, 0x2e, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x44, 0x6f, 0x6d, 0x61, 0x69,
	0x6e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14,
	...
	0x12, 0x1a, 0x2e, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x44,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x12, 0x2e, 0x61,
	0x63, 0x74, 0x6f, 0x72, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x19, 0x2e, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x4c,
...
var file_proto_actor_domain_proto_goTypes = []interface{}{
	...
	(*ListRequest)(nil),          // 6: actor.ListRequest
	(*BlankResponse)(nil),        // 7: actor.BlankResponse
}
var file_proto_actor_domain_proto_depIdxs = []int32{
	4, // 0: actor.DomainListResponse.status:type_name -> actor.Status
	5, // 1: actor.DomainListResponse.domain:type_name -> actor.DomainEntity
	0, // 2: actor.Domain.Create:input_type -> actor.DomainCreateRequest
	1, // 3: actor.Domain.Delete:input_type -> actor.DomainDeleteRequest
	6, // 4: actor.Domain.List:input_type -> actor.ListRequest
	3, // 5: actor.Domain.Execute:input_type -> actor.DomainExecuteRequest
	7, // 6: actor.Domain.Create:output_type -> actor.BlankResponse
	7, // 7: actor.Domain.Delete:output_type -> actor.BlankResponse
	2, // 8: actor.Domain.List:output_type -> actor.DomainListResponse
	7, // 9: actor.Domain.Execute:output_type -> actor.BlankResponse
