...
type ListRequest struct {
	...
	Offset string `protobuf:"bytes,1,opt,name=offset,proto3" json:"offset,omitempty"` // 偏移
	Count  string `protobuf:"bytes,2,opt,name=count,proto3" json:"count,omitempty"`   // 数量
}
...
func (x *ListRequest) GetCount() string {
	if x != nil {
		return x.Count
	}
	return ""
...
var file_proto_actor_shared_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63,
