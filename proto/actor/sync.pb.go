...
var file_proto_actor_sync_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x22, 0xe6, 0x01, 0x0a, 0x10, 0x53, 0x79, 0x6e, 0x63, 0x50,
	...
	0x41, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	,
...
var file_proto_actor_sync_proto_goTypes = []interface{}{
	...
	nil,                      // 6: actor.SyncPullResponse.PropertyEntry
	(*DeviceEntity)(nil),     // 7: actor.DeviceEntity
	(*Status)(nil),           // 8: actor.Status
}
var file_proto_actor_sync_proto_depIdxs = []int32{
	7, // 0: actor.SyncPushRequest.device:type_name -> actor.DeviceEntity
	4, // 1: actor.SyncPushRequest.upProperty:type_name -> actor.SyncPushRequest.UpPropertyEntry
	8, // 2: actor.SyncPushResponse.status:type_name -> actor.Status
	5, // 3: actor.SyncPushResponse.property:type_name -> actor.SyncPushResponse.PropertyEntry
	8, // 4: actor.SyncPullResponse.status:type_name -> actor.Status
	7, // 5: actor.SyncPullResponse.device:type_name -> actor.DeviceEntity
	6, // 6: actor.SyncPullResponse.property:type_name -> actor.SyncPullResponse.PropertyEntry
	0, // 7: actor.Sync.Push:input_type -> actor.SyncPushRequest
	2, // 8: actor.Sync.Pull:input_type -> actor.SyncPullRequest
	1, // 9: actor.Sync.Push:output_type -> actor.SyncPushResponse
	3, // 10: actor.Sync.Pull:output_type -> actor.SyncPullResponse
